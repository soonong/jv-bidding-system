    ...
    return (
        <div className="flex-1 px-6 pb-6 overflow-hidden flex flex-col">
            <div className="bg-white rounded-xl border border-[#e7ebf3] shadow-sm flex flex-col h-full overflow-hidden">
                {/* Header */}
                <div className="grid grid-cols-7 border-b border-[#e7ebf3] bg-[#fcfcfd] shrink-0 min-w-[700px] md:min-w-0">
                    {weekDays.map((day) => (
                ...
                <div className="flex-1 overflow-y-auto overflow-x-auto min-h-0 relative">
                    <div className="grid grid-cols-7 min-h-full divide-x divide-y divide-[#e7ebf3] min-w-[700px] md:min-w-0">
                                            ...
                                            .map(([key, val]) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`
                                                        w-full text-left text-xs px-2 py-1.5 rounded truncate transition-all border-l-2
