    ...
    return (
        <div className="flex-1 px-6 pb-6 overflow-hidden flex flex-col">
            <div className="bg-white rounded-xl border border-[#e7ebf3] shadow-sm flex flex-col h-full overflow-hidden">
                {/* Header Row */}
                <div className="grid grid-cols-7 border-b border-[#e7ebf3] bg-[#fcfcfd] shrink-0 overflow-y-scroll pr-[8px]" style={{ scrollbarWidth: 'none' }}>
                    {weekDays.map((date, i) => (
                ...
                <div className="flex-1 overflow-y-auto relative overflow-x-auto">
                    <div className="grid grid-cols-7 h-full divide-x divide-[#e7ebf3] min-w-[700px] md:min-w-0">
                        {weekDays.map((date, i) => {
